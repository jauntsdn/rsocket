 ...
 */
package com.jauntsdn.rsocket.internal.jctools.queues;

import static com.jauntsdn.rsocket.internal.jctools.queues.CircularArrayOffsetCalculator.allocate;
import static com.jauntsdn.rsocket.internal.jctools.util.UnsafeAccess.UNSAFE;
import static com.jauntsdn.rsocket.internal.jctools.util.UnsafeAccess.fieldOffset;
import static com.jauntsdn.rsocket.internal.jctools.util.UnsafeRefArrayAccess.calcElementOffset;
import static com.jauntsdn.rsocket.internal.jctools.util.UnsafeRefArrayAccess.lvElement;
import static com.jauntsdn.rsocket.internal.jctools.util.UnsafeRefArrayAccess.soElement;

import com.jauntsdn.rsocket.internal.jctools.util.PortableJvmInfo;
import com.jauntsdn.rsocket.internal.jctools.util.Pow2;
import com.jauntsdn.rsocket.internal.jctools.util.RangeUtil;
...
public abstract class BaseMpscLinkedArrayQueue<E>
  ...
  private E newBufferPoll(E[] nextBuffer, long index) {
    final long offset = LinkedArrayQueueUtil.modifiedCalcElementOffset(index, consumerMask);
  ...
  private final class WeakIterator implements Iterator<E> {
    ...
    private void setBuffer(E[] buffer) {
      ...
      this.currentBufferLength = LinkedArrayQueueUtil.length(buffer);
      this.nextIndex = 0;
    }
