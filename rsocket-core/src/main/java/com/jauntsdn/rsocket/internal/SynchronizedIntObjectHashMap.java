 ...
 */
public class SynchronizedIntObjectHashMap<V> implements IntObjectMap<V> {
  ...
  public synchronized V[] getValuesCopy() {
  ...
  @Override
  public synchronized void putAll(Map<? extends Integer, ? extends V> sourceMap) {
    if (sourceMap instanceof SynchronizedIntObjectHashMap) {
      // Optimization - iterate through the arrays.
      @SuppressWarnings("unchecked")
      SynchronizedIntObjectHashMap<V> source = (SynchronizedIntObjectHashMap<V>) sourceMap;
  ...
  @Override
  public synchronized Iterable<PrimitiveEntry<V>> entries() {
    return entries;
  }
  ...
  @Override
  public synchronized Set<Entry<Integer, V>> entrySet() {
    return entrySet;
  }
  ...
  private final class EntrySet extends AbstractSet<Entry<Integer, V>> {
    ...
    @Override
    public int size() {
      return SynchronizedIntObjectHashMap.this.size();
    }
  }
  ...
  private final class KeySet extends AbstractSet<Integer> {
    ...
    public boolean contains(Object o) {
      return SynchronizedIntObjectHashMap.this.containsKey(o);
    }

    @Override
    public boolean remove(Object o) {
      return SynchronizedIntObjectHashMap.this.remove(o) != null;
    }

    @Override
    public boolean retainAll(Collection<?> retainedKeys) {
      synchronized (SynchronizedIntObjectHashMap.this) {
    ...
    @Override
    public void clear() {
      SynchronizedIntObjectHashMap.this.clear();
    }

    @Override
    public Iterator<Integer> iterator() {
      synchronized (SynchronizedIntObjectHashMap.this) {
        final Iterator<Entry<Integer, V>> iter = entrySet.iterator();
