...
package com.jauntsdn.rsocket.client;

import com.jauntsdn.rsocket.*;
import com.jauntsdn.rsocket.client.filter.RSocketSupplier;
import com.jauntsdn.rsocket.stat.Ewma;
import com.jauntsdn.rsocket.stat.FrugalQuantile;
import com.jauntsdn.rsocket.stat.Median;
...
public abstract class LoadBalancedRSocketMono extends Mono<RSocket>
  ...
  private static class FailingRSocket implements RSocket {
    ...
    private static final Mono<Void> errorVoid = error(NoAvailableRSocketException.INSTANCE);
    private static final Mono<Payload> errorPayload = error(NoAvailableRSocketException.INSTANCE);
